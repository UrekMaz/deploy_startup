...
const StartupConnect = () => {
    ...
    const fetchData = async () => {
      try {
        ...
        const [requestsResponse, sentRequestsResponse, collectReqResponse] = await Promise.all([
          axios.get(`https://deploy-startup.vercel.app/api/investorK/${startupId}`),
          axios.get(`https://deploy-startup.vercel.app/api/investorrequest/startup/${startupId}`),
          axios.get(`https://deploy-startup.vercel.app/api/investorreq/${startupId}`)
        ]);
  ...
  const handleRequestAction = async (requestId, action) => {
    try {
      const response = await axios.patch(`https://deploy-startup.vercel.app/api/investorrequest/${requestId}`, {
        status: action,
        startupId,
      });
  ...
  const handleRequestSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('https://deploy-startup.vercel.app/api/investorrequest', {
